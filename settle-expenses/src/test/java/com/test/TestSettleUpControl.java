...
public class TestSettleUpControl {
    ...
    @Autowired
    public TestSettleUpControl(GroupExpenseRepository groupExpenseRepository, ExpenseUserRepository expenseUserRepository, ExpenseRepository expenseRepository, GroupRepository groupRepository, UserRepository userRepository, SettleUpController settleUpController) {
